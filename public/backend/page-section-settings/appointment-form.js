(function($) {
    ...
    const submit = form.querySelector('.btn-theme');
    ...
    function react(data){
        if (data = 'success'){
            form.getElementsByClassName('form-row')[1].querySelector('.form-group').innerHTML = '<p class="text-white">Your request hasbeen sent to admin.</p>';
            setTimeout(function(){

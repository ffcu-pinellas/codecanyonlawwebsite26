            ...
            <div class="col-12">
                <div class="card card-light bg-white text-light rounded">
                    <div class="card-header bg-dark expand-btn">
                        <div class="col-6">
                            <span class="card-title font-weight-bold">{{ __('Breadcamb Section') }}</span>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-light bg-white text-light rounded">
                    <div class="card-header bg-dark expand-btn">
                        <div class="col-6">
                            <span class="card-title font-weight-bold">{{ __('Contact Info') }}</span>
                        </div>
                        <div class="col-6 text-right">
                            <i class="fas fa-chevron-circle-down fa-2x"></i>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-light bg-white text-light rounded">
                    <div class="card-header bg-dark expand-btn">
                        <div class="col-6">
                            <span class="card-title font-weight-bold">{{ __('Business Hours') }}</span>
                        </div>
                        <div class="col-6 text-right">
                            <i class="fas fa-chevron-circle-down fa-2x"></i>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-light bg-white text-light rounded">
                    <div class="card-header bg-dark expand-btn">
                        <div class="col-6">
                            <span class="card-title font-weight-bold">{{ __('Show Email') }}</span>
                        </div>
                        <div class="col-6 text-right">
                            <i class="fas fa-chevron-circle-down fa-2x"></i>
                        </div>
                            ...
                            <div class="row d-none">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="line_one" id="email-one" class="form-control" required value="{{ $settingsPage->sections()->where('name','email')->first()?$settingsPage->sections()->where('name','email')->first()->line_one:'' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="email-two" class="card-title">{{ __('Email Two') }}</label>
                                        <input type="email" name="line_two" id="email-two" class="form-control" value="{{ $settingsPage->sections()->where('name','email')->first()?$settingsPage->sections()->where('name','email')->first()->line_two:'' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-12">
                <div class="card card-dark bg-dark">
                    <div class="card-header">
                        <h6 class="card-title">{{__('contact page SEO Settings')}}</h6>
                    </div>
                    <div class="card-body ">

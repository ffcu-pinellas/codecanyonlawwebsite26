                                    ...
                                    <td>
                                         <div class="d-flex flex-wrap align-items-center">
                                             ...
                                             @if($client->id !== auth()->id())
                                                 <form action="{{ route('admin.user.destroy', $client->id) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to delete this user? This action cannot be undone.') }}');" class="d-inline">
                                                     @csrf
                                                     @method('DELETE')

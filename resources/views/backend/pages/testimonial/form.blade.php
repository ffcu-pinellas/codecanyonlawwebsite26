            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-dark bg-dark">
                        ...
                        <form class="" action="{{route('admin.testimonial.store')}}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <p class="mb-1"><label for="name"
                                                               class="card-title font-weight-bold">{{__('Name:')}}</label>
                                        </p>
                                        ...
                                        <p class="mb-1"><label for="name"
                                                               class="card-title font-weight-bold">{{__('Designation:')}}</label>
                                        </p>
                                        <div class="input-group input-group-lg mb-3">
                                        ...
                                        <div class="form-group">
                                            <label for="about" class="card-title font-weight-bold">{{__('Testimonial')}}
                                                :</label>
                                            <textarea rows="10" name="testimonial" id="testimonial"
                                                      class="form-control rounded"
                                                      required>{!! clean(old('about')) !!}</textarea>
                                        </div>

                                    </div>
                                    <div class="col-md-5">
                                        <p class="h6 mb-3">{{ __('Image')}}
                                            :<code>{{__('Acceptable image size 96 x 96 pixe')}}l</code></p>
                                        <div class="">
